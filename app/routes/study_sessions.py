...
def time_range_for_hours(hours: int) -> tuple[str, str]:
    if hours <= 1:
        return "18:00", "19:00"
    if hours == 2:
        return "18:00", "20:00"
...
@router.post("/study-sessions/generate")
def generate_study_sessions(request: Request, db: Session = Depends(get_db)):
    ...
    for assignment in assignment_data:
        ...
        for day in candidate_days:
            ...
            start_time, end_time = time_range_for_hours(allocated)
